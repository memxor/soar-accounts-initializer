...
IL_004c:
	...
	}
	{
		...
		(L_22)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(0), (uint32_t)L_25);
		__this->____sign = 1;
		return;
	}
...
IL_00a2:
	...
	}
	{
		...
		uint32_t L_35 = V_1;
		(L_33)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_34)->max_length)), 1))), (uint32_t)L_35);
	}
...
IL_009d:
	{
		...
		uint32_t L_38 = V_6;
		uint32_t L_39 = V_7;
		(L_36)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_37), (uint32_t)((int32_t)((int32_t)L_38&(int32_t)L_39)));
		int32_t L_40 = V_5;
